...
class ConversationItem:
    def __init__(self, screen_text: str = None, order: int = None, choice: str = None, scroll_rate: float = None, activate_quests: list[str] = None, complete_quests: list[str] = None, buttons: dict[int, ConversationItemButton] = None, sample: str = None):
    ...
    def from_gas(cls, item_section: Section) -> ConversationItem:
        ...
        return ConversationItem(screen_text, order, choice, scroll_rate, activate_quests, complete_quests, buttons, sample)
