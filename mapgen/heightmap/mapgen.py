...
def generate_region(_map, region_name, size_x, size_z, args: Args, rt: RegionTiling):
    ...
    region_id = region_i if args.region_id == 'tile' else None
    region: Region = _map.create_region(region_name, region_id)
    ...
    if args.start_pos is not None:
        ...
        region.objects.generated_objects.append(
    ...
    if plants is not None:
        region.objects.generated_objects.extend([
            GameObjectData(
                plant.template_name,
